...
define( 'CONSTANTCONTACT_MAILMUNCH_VERSION', '2.0.1' );
...
class Constantcontact_Mailmunch {
	...
	*/
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Constantcontact_Mailmunch_Admin( $this->get_plugin_name(), $this->get_intgration_name(), $this->get_version() );
