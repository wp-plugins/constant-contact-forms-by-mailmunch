<?php
  class ConstantcontactMailmunchApi {
    protected $base_url = '';
    protected $email = '';
    protected $password = '';
    ...
    function getWidgetsHtml($site_id) {
      $this->requestType = 'get';
      return $this->ping('/sites/'.$site_id.'/widgets/wordpress?plugin=constantcontact');
    }
    ...
    function createSite($sitename, $domain) {
      ...
      return $this->ping('/sites', array(
        'site' => array(
          ...
          'domain' => $domain,
          'wordpress' => true,
          'external_id' => get_option("cc_mm_wordpress_instance_id")
          )
      ));
    }
    ...
    function createGuestUser() {
      ...
      return $this->ping('/users', array(
        'user' => array(
          ...
          'guest_user' => true,
          'referral' => "constantcontact-wordpress-plugin"
          )
      ), true);
    }
